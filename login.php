...
<body>
    ...
    <div class="main">
        ...
        <div class="welcome">
            <p>
                Welcome back to MMUST Connect. Login
        ...
        <div class="form">
            <form method= "POST" action="login.php">
                ...
                <div class="input_field">
                    ...
                    <input value="<?php echo $email ?>" type="email" name="email" class="input" required>
                </div>
                <div class="input_field">
                    <label for="pass">Password</label>
                    <input  minlength="6" maxlength="30" value="<?php echo $pass ?>" type="password" name="pass" class="input" >
                </div>
                ...
                <p>New to MMUST Connect? <a href="register.php">Sign up</a></p>
            </form>
        </div>
    </div>
</body>
