...
<body>
    ...
    <div class="main">
        ...
        <div class="welcome">
            <p>
                Insert the OTP Number that we've sent
                to your Email Address to Verify
            </p>
        </div>
    </div>
        ...
        <div class="form">
            <form action="">
                <div class="input_field">
                    <label for="fname">OTP NUMBER</label>
                    <input type="text" name="" class="input" required>
                </div>
                <div class="input_field">
                    <input type="submit" name="submit" value="VERIFY" class="btn" required>
                </div>
